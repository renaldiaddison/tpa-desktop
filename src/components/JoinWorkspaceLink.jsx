...
const JoinWorkspaceLink = ({ closeModal }) => {
    ...
    const handleClick = () => {
        navigate(refTitle.current.value)
        closeModal(false)
    }
            ...
            <div className="fixed p-4 w-full max-w-2xl h-full md:h-auto">
                <div className="bg-white rounded-lg shadow dark:bg-gray-700 border-2 relative">
                    ...
                    <div className="py-6 px-6 lg:px-8">
                        <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">Input Link</h3>
...
export default JoinWorkspaceLink