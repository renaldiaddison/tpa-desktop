...
const CloseBoard = ({ close }) => {
    ...
    const handleClick = () => {
        closeBoard()
        navigate("/home")
        toastSuccess("Successfully close board")
    }
            ...
            <div className="fixed p-4 w-[500px] max-w-2xl h-full md:h-auto">
                <div className="bg-white rounded-lg shadow dark:bg-gray-700 border-2 relative">
                    ...
                    <div className="py-6 px-6 lg:px-8">
                        <h3 className="mb-3 text-xl font-medium text-gray-900 dark:text-white">Close Board</h3>
                        <p className="mb-3">Are you sure to close this board?</p>
