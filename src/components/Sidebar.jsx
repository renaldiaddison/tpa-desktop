...
const Sidebar = () => {
  ...
  return (
    ...
    <div className="fixed ml-[-2px]" >
      <div className="border-x-2 top-0 bottom-0 p-6 overflow-y-auto w-[270px] text-center bg-white h-screen">
        <div className="text-xl">
          ...
          <div >
            ...
            <div className=" p-2.5 mt-2 flex items-center rounded-md cursor-pointer hover:underline">
              <span className="text-[15px] ml-4">Boards</span>
            </div>
            <div className="p-2.5 mt-2 flex items-center rounded-md cursor-pointer hover:underline">
              <span className="text-[15px] ml-4">Lists</span>
            </div>
            <div className="p-2.5 mt-2 mb-6 flex items-center rounded-md cursor-pointer hover:underline">
            ...
            <div className="p-2.5 mt-2 flex items-center rounded-md cursor-pointer hover:underline text-red-600">
