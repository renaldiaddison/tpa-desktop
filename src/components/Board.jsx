    ...
    <div className="h-[90vh] overflow-y-auto">
      <div className="flex pt-4 pl-6">
        ...
        {role === "Admin" ? <div className="flex">
          ...
          <svg onClick={() => setShowDelete(true)} xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-1 mt-[5px] opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
