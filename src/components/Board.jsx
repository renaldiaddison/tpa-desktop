    ...
    <div className="h-[90vh] overflow-y-auto">
      <div className="flex pt-4 pl-6">
        ...
        {role === "Admin" ? <div className="flex">
          ...
          <svg onClick={() => setShowDelete(true)} xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-1 mt-[5px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.6">
            <path strokeLinecap="round" strokeLinejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
          </svg>
        </div> : <svg onClick={() => setShowLeave(true)} xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mt-[5px]" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div className="pt-4 pl-6">
        <p className="font-bold text-xl pr-2 mb-5">Member List</p>
      ...
      <div className="pt-10 pl-6">
        <p className="font-bold text-xl pr-2 mb-5">Admin List</p>
        <div className="flex flex-wrap gap-8">
          {admin.map((user) => {
            return (
              <ul key={user.userId} className="border rounded-lg min-w-[250px]">
