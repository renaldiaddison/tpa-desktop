...
const NewList = ({listId, listTitle, listDesc}) => {
  ...
  return (
	<div className="px-6 py-4">
	  <input type="text" id={"title" + listId} name="title" className="font-bold text-xl mb-2 w-full px-1 focus:outline-none" defaultValue={listTitle} onChange={valueChanges} onKeyDown={enterPress}></input>
	  <input type="text" id={"desc" + listId} name="description" className="text-gray-700 text-base px-1 mb-2 focus:outline-none" defaultValue={listDesc} onChange={valueChanges} onKeyDown={enterPress}></input>
