          ...
          <div className="bg-white rounded-lg shadow dark:bg-gray-700 border-2 relative">
            ...
            <div className="py-6 px-6 lg:px-8">
              ...
              <form className="addWorkspace space-y-6">
                ...
                <button className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update Workspace</button>
              </form>
            </div>
          </div>
        </div>
